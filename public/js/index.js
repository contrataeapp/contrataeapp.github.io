document.addEventListener('DOMContentLoaded', () => {
    ...
    function openLoginRequiredModal(loginUrl, cadastroUrl) {
        ...
        if (modalMsg) {
            modalMsg.textContent = 'Para iniciar o contato, entre ou crie sua conta de cliente. Assim o Contrataê oferece mais segurança e confiança para as duas partes.';
        }
        if (modalLinkDest) {
